...
function AdminDashboardContent({ children }: { children: ReactNode }) {
  ...
  return (
    <SidebarProvider>
      <AdminSidebar />
      <SidebarInset>
        <header className="fixed top-0 right-0 left-0 z-50 flex h-16 shrink-0 items-center gap-2 bg-gray-900/95 backdrop-blur-xl border-b border-gray-800 shadow-lg transition-all duration-200 ease-linear">
                    ...
                    <DropdownMenuLabel className="font-normal">
                      <div className="flex items-center gap-3 p-2">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-xs text-gray-400">{user.email}</p>
                          <span className="text-[10px] px-2 py-0.5 rounded-full w-fit bg-linear-to-r from-blue-500 to-orange-500 text-white font-bold uppercase tracking-wider">
                            Admin
                          </span>
                        </div>
                      </div>
