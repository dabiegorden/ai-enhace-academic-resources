...
// File: app/lecturer-dashboard/layout.tsx
// ════════════════════════════════════════════════════════════════════════════
"use client";
...
function LecturerDashboardContent({ children }: { children: ReactNode }) {
  ...
  const roleBadge: Record<string, string> = {
    ...
    lecturer: "from-blue-500 to-blue-600",
              ...
              <div className="flex items-center gap-3">
                ...
                <DropdownMenu>
                  ...
                  >
                    <DropdownMenuLabel className="font-normal">
                      <div className="flex items-center gap-3 p-2">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-xs text-gray-400">{user.email}</p>
                          <span
                            className={`text-[10px] px-2 py-0.5 rounded-full w-fit bg-linear-to-r ${roleBadge[user.role] || roleBadge.lecturer} text-white font-bold uppercase tracking-wider`}
                          >
                            {user.role}
                          </span>
                        </div>
                    ...
                    >
                      <Link href="/lecturer-dashboard/profile">
...
export default function LecturerDashboardLayout({
  ...
  return <LecturerDashboardContent>{children}</LecturerDashboardContent>;
}
